package br.com.joaogosmani.hyperprof.core.services.token.providers.jjwt;
...
import br.com.joaogosmani.hyperprof.core.repositories.TokenInvalidoRepository;
import br.com.joaogosmani.hyperprof.core.services.token.TokenService;
...
public class JjwtTokenService implements TokenService {
    ...
    private Claims tryGetClaims(String token, String sigingKey) {
        ...
        return Jwts.parserBuilder()
            .setSigningKey(sigingKey.getBytes())
            .build()
